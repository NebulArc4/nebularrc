...
const faqs = [
  { q: 'How do I upload a PDF?', a: 'Go to the dashboard, use the Task Submission form, and drag or select your PDF.' },
  { q: 'How do I get AI results as a PDF?', a: 'After submitting a task, use the Download as PDF or Download Annotated PDF buttons.' },
  { q: 'Can I automate tasks with agents?', a: 'Yes! Use the Agent Manager to create and schedule AI agents for recurring tasks.' },
