  ...
  const features = [
    {
      ...
      description: "Deploy intelligent agents that act on your behalf — research, optimize, and execute tasks 24/7.",
      icon: (
    ...
    },
    {
      ...
      description: "Built for high-performance — scale from single-agent tasks to enterprise-level simulations.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
